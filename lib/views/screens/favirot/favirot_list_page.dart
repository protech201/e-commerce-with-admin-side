...
import 'package:myecommerce/views/screens/home/category/components/staggered_category_card.dart';
import 'package:provider/provider.dart';


class FavourtListPage extends StatefulWidget {
  static String routeName = "/favourite";
  @override
  _FavourtListPageState createState() => _FavourtListPageState();
}

class _FavourtListPageState extends State<FavourtListPage> {
                  ...
                  children: <Widget>[
                    ...
                    Flexible(
                      child: ListView.builder(
                        itemCount: provider.categoresLike.length,
                        itemBuilder: (context, index) => Padding(
                          padding: EdgeInsets.symmetric(
                            vertical: 16.0,
                          ),
                          child: StaggeredCardCard(provider.categoresLike[index]),
                        ),
                      ),
                    )
                  ],
